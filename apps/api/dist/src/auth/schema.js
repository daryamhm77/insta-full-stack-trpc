...
exports.accountRelations = exports.sessionRelations = exports.userRelations = exports.followRelations = exports.follow = exports.verification = exports.account = exports.session = exports.user = void 0;
const drizzle_orm_1 = require("drizzle-orm");
const pg_core_1 = require("drizzle-orm/pg-core");
const schema_1 = require("../comments/schemas/schema");
const schema_2 = require("../posts/schemas/schema");
const schema_3 = require("../stories/schemas/schema");
...
exports.follow = (0, pg_core_1.pgTable)("follow", {
    followerId: (0, pg_core_1.text)("follower_id")
        .notNull()
        .references(() => exports.user.id),
    followingId: (0, pg_core_1.text)("following_id")
        .notNull()
        .references(() => exports.user.id),
}, (table) => [
    (0, pg_core_1.primaryKey)({ columns: [table.followerId, table.followingId] }),
]);
exports.followRelations = (0, drizzle_orm_1.relations)(exports.follow, ({ one }) => ({
    follower: one(exports.user, {
        fields: [exports.follow.followerId],
        references: [exports.user.id],
        relationName: "followers",
    }),
    following: one(exports.user, {
        fields: [exports.follow.followingId],
        references: [exports.user.id],
...
exports.userRelations = (0, drizzle_orm_1.relations)(exports.user, ({ many }) => ({
    ...
    posts: many(schema_2.post),
    likes: many(schema_2.like),
    comments: many(schema_1.comment),
    stories: many(schema_3.story),
    followers: many(exports.follow, { relationName: "following" }),
    following: many(exports.follow, { relationName: "followers" }),
}));
